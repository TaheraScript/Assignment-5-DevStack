...
b.A little description about my projrct:
                                        “My project is a React-based technologies data  management application. It loads  data from a JSON file, displays the datas using reusable components, and allows  to add datas to stack. I used React concepts such as JSX, props, state, useState, .map(), conditional rendering, and event handling.”
